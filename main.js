...
var Ic5num = 100; //max baits
var Ic6 = 0;
var Ic6text = "10% chance to catch 2 fish at once";
...
var Ic7 = 0;
var Ic7text = "20% chance to catch 2 fish at once";
...
var Ic8 = 0;
var Ic8text = "30% chance to catch 2 fish at once";
...
var Ic9 = 0;
var Ic9text = "40% chance to catch 2 fish at once";
...
var Ic10 = 0;
var Ic10text = "50% chance to catch 2 fish at once";
...
var Ic19 = 0;
var Ic19text = "70% chance to catch 2 fish at once";
...
var kind3text = "Charity hockey tournament";
var kind3req = 3;//kindness level required
var kind3cost = 5;//Pucks
var kind3costtext = "5 Pucks";
...
var kind4text = "Throw a party for the neighbors";
var kind4req = 4;//kindness level required
var kind4cost = 10;//Salmon
var kind4costtext = "10 Salmon";
...
var kind6text = "Buddy's hands are cold.  Help him out.";
var kind6req = 6;//kindness level required
var kind6cost = 4;//Gloves
var kind6costtext = "4 Gloves";
...
var kind7text = "Host the Wayne Gretzky Fan Club";
var kind7req = 7;//kindness level required
var kind7cost = 2;//Skates
var kind7costtext = "2 Skates";
...
var kind10text = "Prepare the Ice.  It's Game Time!";
var kind10req = 10;//kindness level required
var kind10cost = 1;//Zambonie
var kind10costtext = "1 Zamboni";
...
var kind13text = "Build a pond hockey rink";
var kind13req = 13;//kindness level required
var kind13cost = 125;//Sticks
var kind13costtext = "125 Sticks";
...
var kind14text = "Make car air fresheners";
var kind14req = 14;//kindness level required
var kind14cost = 50000;//Spruce
var kind14costtext = "50,000 Spruce";
...
var kind15text = "Codliness is second to Godliness";
var kind15req = 15;//kindness level required
var kind15cost = 100;//Cod
var kind15costtext = "100 Cod";
...
var kind16text = "Stock the winter wood pile";
var kind16req = 16;//kindness level required
var kind16cost = 10000;//Ash
var kind16costtext = "10,000 Ash";
...
var kind17text = "Sponsor the Canadian Olympic<br> hockey team";
var kind17req = 17;//kindness level required
var kind17cost = 30;//Goals
var kind17costtext = "30 Goals";
...
var kind18text = "Native Canadian pot luck";
var kind18req = 18;//kindness level required
var kind18cost = 45;//Whale
var kind18costtext = "45 Whales";
...
var K16 = 0;
var K16text = "70% More Kindness XP";
...
var K17 = 0;
var K17text = "90% More Kindness XP";
...
var K18 = 0;
var K18text = "100% More Kindness XP";
...
var K19 = 0;
var K19text = "60% chance for double XP";
...
var K20 = 0;
var K20text = "70% chance for double XP";
...
var K21 = 0;
var K21text = "80% chance for double XP";
...
var hockey2text = "Stick Handling Drill";
var hockey2req = 2;//hockey level required
var hockey2reward = 1;//Sticks
var hockey2rewardtext = "1 Stick";
...
var hockey11text = "Put blades on the team";
var hockey11req = 11;//hockey level required
var hockey11reward = 12;//Skates
var hockey11rewardtext = "12 Skates";
...
var hockey15text = "Command the intermission fleet";
var hockey15req = 15;//hockey level required
var hockey15reward = 10;//zambonies
var hockey15rewardtext = "10 Zambonis";
...
var fu5 = 0;
var fu5text = "Poutine";//skin for landscape and tree
var fu5cost = 10;//flannel cost
var fu6 = 0;
var fu6text = "Kraft Dinner";//skin for landscape and tree
var fu6cost = 10;//flannel cost
var fu7 = 0;
var fu7text = "Tim Hortons";//skin for landscape and tree
var fu7cost = 10;//flannel cost
var fu8 = 0;
var fu8text = "Polar Bears";//skin for landscape and tree
var fu8cost = 10;//flannel cost
var fu9 = 0;
var fu9text = "Moose!";//skin for landscape and tree
var fu9cost = 10;//flannel cost
var fu10 = 0;
var fu10text = "Mountie";//skin for landscape and tree
	...
	if (BeardBuff > 0){
		...
		switch (true){
			...
			case (rand==2):
				...
				document.getElementById("BeardBoxReward").innerHTML = "Times "+LumberjackXPMultiplier+" lumberjack XP 每次点击 for "+BeardRewardCountdown+" seconds";
			...
			case (rand==3):
				...
				BeardRewardCountdown = 30;//sets the multiplier countdown
				document.getElementById("BeardBoxReward").innerHTML = "Times "+TreeMultiplier+" trees 每次点击 for "+BeardRewardCountdown+" seconds";
				document.getElementById("BeardBoxXP").innerHTML = "+" + BeardXPearned + " Beard XP";
				break;
...
function BuyStuff(quantity, item){
	if ((quantity !=null) && !isNaN(quantity) && (quantity > 0) && (quantity%1==0) && (Money >= quantity*window[item+"Cost"])){
		...
		document.getElementById("baitupdate").innerHTML = "Bait: "+window[item];
		DisplayStuff('Money');
		DisplayStuff(item);
		//document.getElementById("invalidpurchase").innerHTML = "You bought some Bait!";
	}else{
	document.getElementById("invalidpurchase").innerHTML = "Sorry bro, that input isn't fly";
	}
}
...
function KindnessButton(item){//function to show kindness button
	if (!window[item+"inprogress"]){
				//Kindness activities
			if (getLevel(KindnessXP)>=window[item+"req"]){
				document.getElementById(item).innerHTML = "<button onClick=beKind('"+item+"')>Be Kind!</button>";
			}else{
				document.getElementById(item).innerHTML = "<button onClick=beKind('"+item+"') disabled>Be Kind!</button>";
			}
...
function HockeyButton(item){//function to show hockey button
	if (!window[item+"inprogress"]){
			//Hockey activities
			if (getLevel(HockeyXP)>=window[item+"req"]){
				document.getElementById(item).innerHTML = "<button onClick=doHockey('"+item+"')>Do Hockey!</button>";
			}else{
				document.getElementById(item).innerHTML = "<button onClick=doHockey('"+item+"') disabled>Do Hockey!</button>";
			}
	}
}
...
function PrestigeButton(){
	...
	document.getElementById("PrestigeDisplay").innerHTML = "<img src=images/"+PrestigeImage[Prestige]+".png height=80><br><font size=2>Prestige: "+PrestigeNames[Prestige]+"</font>";
...
function minutesAndSeconds(seconds){//takes an integer in seconds and returns a string
	...
	finalString = dayString + hourString + minuteString + seconds + " Seconds";
	return finalString;
}
